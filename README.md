...
The ultimate custom web experience — **16 mini-games**, a **secret kitchen quest**, and a **full Boston adventure game** — all tailored for Pillu (⚡) and Crow (🐦‍⬛). Lightweight, mobile-friendly, zero frameworks.
...
- Map canvas redraws in full dark palette
...
- **Custom character sprites** — `pikachu.png` and `crow.png` used everywhere
...
| Graphics | HTML5 Canvas (map rendering, table tennis, 8-ball pool) |
